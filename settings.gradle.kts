...
includeBuild("moko-graphics") { substituteMpp() }
includeBuild("moko-parcelize") { substituteMpp() }
includeBuild("moko-resources/resources-generator")
includeBuild("moko-resources") { substituteMpp() }
